...
public class AgeOfFemaleFirstMarriageTest {
	...
	public void testReducer() {
		...
		reduceDriver.withOutput(new Text("23 < Age <= 27"), new DoubleWritable(DoubleFormat(2.59614804050973)));
	...
	public void testMapReduce() {
		...
		mapReduceDriver.addInput(new LongWritable(1), new Text(input2));
		mapReduceDriver.withOutput(new Text("23 < Age <= 27"), new DoubleWritable(DoubleFormat(2.59614804050973)));
		/*
		 * Run the test.
		 */
